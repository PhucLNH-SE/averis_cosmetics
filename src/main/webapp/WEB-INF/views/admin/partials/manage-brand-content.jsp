...
<section class="admin-content__section admin-page admin-page--brand">
    <div class="container py-4">
        ...
        <c:if test="${param.error == 'notFound'}">
            <c:set var="popupMessage" scope="request" value="Brand not found." />
            <c:set var="popupType" scope="request" value="error" />
        </c:if>
                            ...
                            <c:forEach var="brand" items="${brands}">
                                <tr>
                                    ...
                                    <td class="text-end px-4">
                                        <a href="${pageContext.request.contextPath}/admin/manage-brand?action=edit&id=${brand.brandId}"
...
<script>
    function openAddModal() {
        ...
        document.getElementById('brandForm').action = '${pageContext.request.contextPath}/admin/manage-brand?action=add';
    }
    ...
    function openDeleteModal(brandId, brandName) {
        ...
        document.getElementById('deleteModal').querySelector('form').action =
                '${pageContext.request.contextPath}/admin/manage-brand?action=delete';
    }
    <c:if test="${formMode == 'update' and not empty selectedBrand}">
    window.addEventListener('load', function () {
        ...
        document.getElementById('brandId').value = '${selectedBrand.brandId}';
        document.getElementById('brandName').value = '${selectedBrand.name}';
        document.getElementById('brandStatus').checked = ${selectedBrand.status};
        document.getElementById('brandForm').action = '${pageContext.request.contextPath}/admin/manage-brand?action=update';
