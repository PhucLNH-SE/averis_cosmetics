...
<section class="admin-content__section admin-page admin-page--product">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a class="btn btn-outline-secondary px-3" href="${pageContext.request.contextPath}/admin/manage-statistic">
            ...
            <form action="${pageContext.request.contextPath}/admin/manage-product" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="mb-3 text-center">
                         <img id="editImageDisplay"
                              src="${pageContext.request.contextPath}/assets/img/${not empty selectedProduct.mainImage ? selectedProduct.mainImage : 'Logo.png'}"
                              width="100" height="100" class="rounded border mb-2 product-image-current">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" id="editName" class="form-control" required value="<c:out value='${selectedProduct.name}'/>">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="brandId" id="editBrand" class="form-select">
                                <c:forEach items="${listB}" var="b">
                                    <option value="${b.brandId}" ${not empty selectedProduct and selectedProduct.brand.brandId == b.brandId ? 'selected' : ''}>${b.name}</option>
                                </c:forEach>
                            </select>
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="categoryId" id="editCategory" class="form-select">
                                <c:forEach items="${listC}" var="c">
                                    <option value="${c.categoryId}" ${not empty selectedProduct and selectedProduct.category.categoryId == c.categoryId ? 'selected' : ''}>${c.name}</option>
                                </c:forEach>
                            </select>
                        </div>
                    </div>
