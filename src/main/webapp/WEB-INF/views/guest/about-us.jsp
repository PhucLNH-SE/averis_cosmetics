        ...
        <section class="cta">
            <div class="about-container">
                ...
                <div class="cta-actions">
                    <a class="cta-btn primary" href="${pageContext.request.contextPath}/products">Explore products</a>
                    <a class="cta-btn secondary" href="${pageContext.request.contextPath}/contact">Contact us</a>
                </div>
            </div>
        </section>
    </main>
