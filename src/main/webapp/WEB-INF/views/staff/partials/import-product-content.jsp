...
<section class="admin-content__section admin-page admin-page--product">
    <div class="mb-4">
        <div>
            ...
            <p class="text-muted small mb-0">Select a product and create an import order</p>
        </div>
    </div>
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body p-4">
            <div class="product-toolbar mb-4">
                <form action="${pageContext.request.contextPath}/staff/manage-import-product" method="get" class="product-search-form">
                    ...
                    <div class="product-search-form__row">
                        ...
                        <a class="btn btn-outline-secondary px-4" href="${pageContext.request.contextPath}/staff/manage-import-product?action=importproduct">
                            Reset
                        </a>
                    </div>
...
<div class="modal fade" id="importModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
            <form action="${pageContext.request.contextPath}/staff/manage-import-product" method="post">
                <input type="hidden" name="action" value="importproduct">
