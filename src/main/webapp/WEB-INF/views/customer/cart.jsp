    ...
    <div class="cart-container">
        ...
        <c:if test="${empty cart}">
            <div class="cart-main empty-cart">
                ...
                <a href="${pageContext.request.contextPath}/products" class="btn-checkout empty-cart-btn">
                    Continue Shopping
                </a>
            </div>
        </c:if>
                            ...
                            <c:choose>
                                <c:when test="${not empty entry.value.variant.imageUrl}">
                                    <img class="cart-product-image"
                                         src="${pageContext.request.contextPath}/assets/img/${entry.value.variant.imageUrl}"
                                         alt="Product"
