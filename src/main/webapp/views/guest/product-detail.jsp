        ...
        <main class="product-detail-shell">
            <c:if test="${not empty product}">
                <section class="product-detail-hero">
                    <a href="<%=request.getContextPath()%>/products" class="product-back-link" title="Back to products">
                    ...
                    <div class="product-detail-card">
                        <section class="product-gallery-panel">
                            <div class="product-gallery-frame">
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <img class="product-main-image" src="<%=request.getContextPath()%>/assets/img/Logo.png" alt="No image available">
                                    </c:otherwise>
                                </c:choose>
                            </div>
                        ...
                        <section class="product-summary-panel">
                            ...
                            <div class="product-detail-actions">
                                ...
                                <a href="<%=request.getContextPath()%>/contact" class="product-action-btn secondary">
            ...
            <c:if test="${empty product}">
                <div class="product-empty-state">
                    ...
                    <a href="<%=request.getContextPath()%>/products" class="product-action-btn primary">
                        Back to store
                    </a>
                </div>
            </c:if>
