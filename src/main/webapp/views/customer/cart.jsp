...
<head>
    ...
    <title>Shopping Cart | Averis Cosmetics</title>
    ...
    <div class="cart-container">
        ...
        <c:if test="${empty cart}">
            <div class="cart-main empty-cart">
                <div class="empty-icon">🛒</div> <h3>Your shopping cart is empty</h3>
                <p style="color: var(--muted); margin-bottom: 24px;">Let's add some items to start shopping.</p>
                        ...
                        <div class="item-details">
                            ...
                            <div class="item-actions">
                                ...
                                <form action="cart" method="post" style="margin:0;">
                                    ...
                                    <button class="btn-delete" onclick="return confirm('Are you sure you want to remove this item?')">
                                        Remove
                                    </button>
                                </form>
                            </div>
