...
<main class="container py-4">
    ...
    <c:if test="${category == null}">
        <div class="alert alert-danger" role="alert">
            <i class="bi bi-exclamation-circle me-2"></i>Category not found!
        </div>
                    ...
                    <div class="card-body">
                        <form action="${pageContext.request.contextPath}/admin/category" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="categoryId" value="${category.categoryId}" disabled>
                            </div>

                            <div class="mb-3">
                                <label for="name" class="form-label">Category Name <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="name" name="name" required 
                                       value="${category.name}" placeholder="Enter category name" maxlength="100">
