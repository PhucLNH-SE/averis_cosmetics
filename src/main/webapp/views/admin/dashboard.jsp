...
<main class="container py-4">
    ...
    <section class="row g-3">
        ...
        <div class="col-12 col-lg-6">
            <div class="card h-100 border-0 shadow-sm">
                <div class="card-body">
                    <h2 class="h5"><i class="bi bi-tag me-2"></i>Manage Category</h2>
                    <p class="text-muted">Quản lý danh mục, thêm mới và cập nhật danh mục.</p>
                    <div class="d-flex gap-2 flex-wrap">
                        <a class="btn btn-primary" href="${pageContext.request.contextPath}/admin/category?action=list">Manage Category</a>
                        <a class="btn btn-outline-primary" href="${pageContext.request.contextPath}/admin/category?action=add">Add Category</a>
                    </div>
                </div>
            </div>
        </div>
