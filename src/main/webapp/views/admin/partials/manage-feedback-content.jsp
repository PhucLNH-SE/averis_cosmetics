...
<section class="admin-content__section admin-page admin-page--feedback">
...
<script>
    function viewProductReviews(productId, productName) {
        ...
        fetch('${pageContext.request.contextPath}/admin/manage-feedback?action=getComments&productId=' + productId)
