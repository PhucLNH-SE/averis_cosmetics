            ...
            <div class="card mb-4 border-0 shadow-sm rounded-4">
                <div class="card-body p-4">
                    ...
                    <c:if test="${not empty c.responseContent}">
                        <div class="fb-admin-response mb-4">
                            <div class="small fw-bold text-primary mb-1">admin (${c.managerName}):</div>
                    ...
                    <div class="collapse mt-3" id="replyForm${c.orderDetailId}">
                        <form action="${pageContext.request.contextPath}/admin/manage-feedback" method="post">
