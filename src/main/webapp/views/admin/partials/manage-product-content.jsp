                        ...
                        <div class="d-flex gap-2 mb-2 p-2 border-bottom align-items-end bg-white">
                            <form action="${pageContext.request.contextPath}/admin/manage-variant" method="post" class="d-flex gap-2 flex-grow-1 align-items-end mb-0">
                                ...
                                <div class="flex-grow-1">
                                    <label class="small text-muted mb-1">Variant Name</label>
                            ...
                            <form action="${pageContext.request.contextPath}/admin/manage-variant" method="post" class="mb-0" onsubmit="return confirm('Do you want delete?');">
...
<script>
    function openVariantModal(button) {
        ...
        document.getElementById('variantListContainer').innerHTML =
            document.getElementById('variants-data-' + productId).innerHTML;
    ...
    function openEditModal(button) {
        ...
        document.getElementById('editImageDisplay').src =
            '${pageContext.request.contextPath}/assets/img/' + button.getAttribute('data-image');
